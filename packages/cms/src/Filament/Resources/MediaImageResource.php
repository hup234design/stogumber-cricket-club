...
use Hup234design\Cms\Filament\Forms\Components\MediaImageCropper;
use Hup234design\Cms\Filament\Forms\Components\MediaImagePicker;
use Hup234design\Cms\Filament\Resources\MediaImageResource\Pages;
use Hup234design\Cms\Filament\Resources\MediaImageResource\RelationManagers;
                        ...
                        Forms\Components\Tabs\Tab::make('Image')
                            ->schema([
                                Forms\Components\ViewField::make('image')
                                    ->label(false)
                                    ->view('cms::filament.forms.components.media-image'),
                        ...
                        Forms\Components\Tabs\Tab::make('Banner Conversion')
                            ->schema([
                                Forms\Components\ViewField::make('conversions.banner')
                                    ->label(false)
                                    ->view('cms::filament.forms.components.media-image-cropper')
                                    ->viewData([
                                        'conversion' => 'banner',
